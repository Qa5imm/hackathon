export default function Dashboard() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-100 to-cyan-100 p-4 flex items-center justify-center py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="border-4 border-black bg-white p-4 transform hover:-rotate-1 transition">
            ...
            <div className="border-t-2 border-black mt-4 pt-4 flex gap-2">
              <button className="flex-1 px-3 py-2 bg-black text-white text-sm font-bold hover:bg-gray-800">
                EDIT →
              </button>
